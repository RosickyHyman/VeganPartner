...
class VeganExtendedMaterialTextSelectionControls extends ExtendedMaterialTextSelectionControls {
  VeganExtendedMaterialTextSelectionControls();
  @override
  Widget buildToolbar(
          ...
          child: _TextSelectionToolbar(
            ...
            handleLike: () {
              ...
              delegate.textEditingValue =
                  delegate.textEditingValue.copyWith(selection: TextSelection.collapsed(offset: delegate.textEditingValue.selection.end));
            },
          ),
        ),
      ],
...
class _TextSelectionToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (handleLike != null) {
      items.add(FlatButton(child: const Icon(Icons.favorite), onPressed: handleLike));
    }
