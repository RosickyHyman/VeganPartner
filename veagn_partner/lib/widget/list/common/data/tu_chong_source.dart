...
class TuChongSource {
  ...
  factory TuChongSource.fromJson(Map<String, dynamic> jsonRes) {
    ...
    final List<TuChongItem> feedList = jsonRes['feedList'] is List ? <TuChongItem>[] : null;
    if (feedList != null) {
...
class TuChongItem {
  ...
  factory TuChongItem.fromJson(Map<String, dynamic> jsonRes) {
    ...
    final List<Object> commentListPrefix = jsonRes['comment_list_prefix'] is List ? <Object>[] : null;
    ...
    final List<String> eventTags = jsonRes['event_tags'] is List ? <String>[] : null;
    if (eventTags != null) {
    ...
    final List<Object> favoriteListPrefix = jsonRes['favorite_list_prefix'] is List ? <Object>[] : null;
    ...
    final List<ImageItem> images = jsonRes['images'] is List ? <ImageItem>[] : null;
    if (images != null) {
    ...
    final List<Object> rewardListPrefix = jsonRes['reward_list_prefix'] is List ? <Object>[] : null;
...
class Site {
  ...
  factory Site.fromJson(Map<String, dynamic> jsonRes) {
    ...
    final List<VerificationList> verificationList = jsonRes['verification_list'] is List ? <VerificationList>[] : null;
    if (verificationList != null) {
      for (final dynamic item in jsonRes['verification_list']) {
        if (item != null) {
          tryCatch(() {
            verificationList.add(VerificationList.fromJson(asT<Map<String, dynamic>>(item)));
          });
        }
      }
    }
...
class VerificationList {
  ...
  factory VerificationList.fromJson(Map<String, dynamic> jsonRes) => jsonRes == null
      ? null
      : VerificationList(
