    ...
    result = ExtendedImageSlidePage(
      ...
      slideScaleHandler: (
        ...
        if (detailKeys[_currentIndex] != null && state.scale == 1.0) {
          ...
          if (state != null && state.imageGestureState.gestureDetails.totalScale > 1.0) {
            return 1.0;
          }
...
// get magnitude from gesture velocity
            ...
            if (doubleCompare(magnitude, minMagnitude) >= 0) {
              ...
              _slideEndAnimation = _slideEndAnimationController.drive(Tween<double>(
                begin: _imageDetailY,
                end: (_imageDetailY + direction.dy).clamp(-detailKeys[_currentIndex].maxImageDetailY, 0.0) as double,
              ));
          ...
          Column(
            ...
            children: <Widget>[
              ...
              ExtendedText(
                ...
                textSelectionControls: VeganExtendedMaterialTextSelectionControls(),
              ),
              const SizedBox(
                height: 20.0,
              ),
